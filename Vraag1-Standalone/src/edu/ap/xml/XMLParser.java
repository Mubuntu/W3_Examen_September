	...
	public String getBestellingen() {
		...
		try {
			...
			for (int i = 0; i < bestellingen.getLength(); i++) {
				...
				result += "<br/><b>Datum  : </b>" + eElement.getAttribute("datum");
				...
				for(int j =0;j<producten.getLength(); j++){
					Node pNode = producten.item(j);
					Element pElement = (Element) pNode;
					result += "<br/><b>product : </b>" + pElement.getAttribute("productName");
					result += "<br/><b>hoeveelheid : </b>" + pElement.getAttribute("quantity");
				}
				result += "<br/>";
			}
